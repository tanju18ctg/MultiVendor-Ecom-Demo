...
export default {
    ...
    methods: {
        ...
        fetchSubCategory() {
            this.$store
                .dispatch(
                    "subcategory/FETCH_DATA_NO_PAGINATE",
        ...
        fetchBrand() {
            this.$store.dispatch("brand/FETCH_DATA_NO_PAGINATE");
        },

        fetchSize() {
            this.$store.dispatch("size/FETCH_DATA");
        },

        fetchColor() {
            this.$store.dispatch("color/FETCH_DATA");
        },
        ...
        storeProduct() {
            this.loading = true;
            this.$store
                .dispatch("product/STORE_DATA", this.form)
                .then((res) => {
                    if (res.data.status == true) {
                        this.clearForm();
                        ElNotification({
