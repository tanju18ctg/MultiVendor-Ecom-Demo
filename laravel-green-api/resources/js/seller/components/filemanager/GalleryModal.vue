...
import ImageGallerySkeleton from "../../../components/skeleton/ImageGallerySkeleton.vue";
export default {
    components: { Plus, NewUpload, ImageGallerySkeleton },
    data() {
        return {
            dialogImageUrl: ref(""),
