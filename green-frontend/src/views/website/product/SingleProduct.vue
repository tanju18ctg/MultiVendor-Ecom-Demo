  ...
  <div>
    ...
    <section class="inner-section">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="details-gallery">
              <div class="details-label-group">
                <label class="details-label new">{{ product.conditions }}</label
                ><label class="details-label off" v-if="product.discount"
                  >-{{ product.discount }}%</label
                >
              </div>
              <ul
                class="details-preview"
                @click="detailsPreview"
                v-if="product.image"
              >
                <li v-for="(img, index) in product.image" :key="index">
                  <!-- <img :src="img" alt="product" /> -->
                  <Dynamic-img :path="img" />
                </li>
                <!-- <li><img src="/website/images/product/01.jpg" alt="product" /></li>
                <li><img src="/website/images/product/01.jpg" alt="product" /></li>
                <li><img src="/website/images/product/01.jpg" alt="product" /></li>
                <li><img src="/website/images/product/01.jpg" alt="product" /></li> -->
              </ul>
          ...
          <div class="col-lg-6" v-if="product.price">
            <div class="details-content">
              ...
              <div class="details-meta">
                ...
                <p v-if="product.shop">
                  Shop:<a href="#">{{ product.shop.name }}</a>
                </p>
              </div>
              ...
              <!-- <div class="view-list-group" v-if="product.size">
                <label class="view-list-title" v-if="product.size.length > 0"
                  >Sizes:</label
                >
              ...
              <div class="view-list-group" v-if="product.size">
                <label class="view-list-title" v-if="product.color.length > 0"
                  >Colors:</label
                >
        ...
        <div class="tab-pane fade show active" id="tab-desc">
          <div class="row">
            ...
            <!-- <div class="col-lg-6">
              <div class="product-details-frame">
                <div class="tab-descrip">
                  <img src="/website/images/video.jpg" alt="video" /><a
                    title="Product Video"
              ...
              <div class="product-details-frame">
                <ul class="review-list">
                  <li class="review-item">
                    <div class="review-media">
                      <a class="review-avatar" href="#"
                        ><img src="/website/images/avatar/01.jpg" alt="review"
                      /></a>
                  ...
                  <li class="review-item">
                    <div class="review-media">
                      <a class="review-avatar" href="#"
                        ><img src="/website/images/avatar/04.jpg" alt="review"
                      /></a>
                      <h5 class="review-meta">
    ...
    <!-- <section class="inner-section">
      <div class="container">
        <div class="row">
          <div class="col">
            <div class="section-heading"><h2>related this items</h2></div>
          </div>
        </div>
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                ><a class="product-image" href="product-video.html"
                  ><img src="/website/images/product/01.jpg" alt="product"
                /></a>
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="/website/images/product/02.jpg" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="/website/images/product/03.jpg" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="/website/images/product/04.jpg" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="/website/images/product/05.jpg" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="/website/images/product/06.jpg" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="/website/images/product/07.jpg" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="/website/images/product/08.jpg" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card product-disable">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="/website/images/product/09.jpg" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
            ...
            <div class="product-card">
              <div class="product-media">
                ...
                <button class="product-wish wish">
                  <i class="fas fa-heart"></i></button
                ><a class="product-image" href="product-video.html"
                  ><img src="/website/images/product/10.jpg" alt="product"
                /></a>
                <div class="product-widget">
                  <a
                    title="Product Compare"
          ...
          <div class="col-lg-12">
            <div class="section-btn-25">
              <a href="shop-4column.html" class="btn btn-outline"
                ><i class="fas fa-eye"></i><span>view all related</span></a
              >
            </div>
          </div>
        </div>
...
export default {
  name: "SingleProduct",
  components: { ProductPrice, DynamicImg },
  ...
  methods: {
    fetchProduct() {
      ...
      this.$store.dispatch("product/FETCH_SINGLE_PRODUCT", slug);
    },
  ...
  computed: {
    product() {
      return this.$store.getters["product/GET_SINGLE_PRODUCT"];
    },
  },
};
</script>
